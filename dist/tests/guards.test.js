...
(0, node_test_1.describe)("daobrew_breathe guard: disabled", () => {
...
(0, node_test_1.describe)("daobrew_breathe guard: session_active", () => {
    (0, node_test_1.beforeEach)(() => {
...
(0, node_test_1.describe)("daobrew_breathe guard: cooldown", () => {
    (0, node_test_1.beforeEach)(() => {
...
(0, node_test_1.describe)("daobrew_breathe guard: ambient requires optin", () => {
    (0, node_test_1.beforeEach)(() => {
...
(0, node_test_1.describe)("daobrew_breathe audio error", () => {
    (0, node_test_1.beforeEach)(() => {
    ...
    (0, node_test_1.it)("attempts audio playback (playing or error depending on files)", async () => {
        ...
        assert.ok(result.__mcp_content__ === true || result.status === "audio_error", `Expected session start (__mcp_content__) or audio_error, got keys=${Object.keys(result)}`);
        if (result.__mcp_content__) {
            await (0, development_tools_js_1.handleToolCall)("daobrew_stop", {}, true);
        }
        (0, session_js_1.clearSession)();
        cooldown.clearAll();
    });
});
(0, node_test_1.describe)("daobrew_settings validation", () => {
