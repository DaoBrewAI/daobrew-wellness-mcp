...
(0, node_test_1.describe)("daobrew_stop", () => {
    (0, node_test_1.it)("returns no_active_session when nothing playing", async () => {
        const { handleToolCall } = await import("../src/development-tools.js");
...
(0, node_test_1.describe)("daobrew_check returns content blocks", () => {
    (0, node_test_1.it)("returns __mcp_content__ marker on first call", async () => {
        const { handleToolCall } = await import("../src/development-tools.js");
...
(0, node_test_1.describe)("daobrew_breathe guards", () => {
    (0, node_test_1.it)("rejects ambient mode without optin", async () => {
        ...
        const { handleToolCall } = await import("../src/development-tools.js");
        const result = await handleToolCall("daobrew_breathe", { stress_pattern: "tension", mode: "ambient" }, true);
