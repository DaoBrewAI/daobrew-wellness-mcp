...
const icons_base64_js_1 = require("./icons-base64.js");
...
function generateDashboardHTML(element, durationSec) {
    const pattern = types_js_1.ELEMENT_TO_STRESS_PATTERN[element];
    const copy = copy_js_1.STRESS_PATTERN_COPY[pattern];
    const color = PATTERN_COLORS[element];
    const iconDataURL = icons_base64_js_1.PATTERN_ICON_DATA_URL[element];
