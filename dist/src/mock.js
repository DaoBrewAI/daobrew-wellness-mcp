...
exports.AI2_DEMO_ARTIFACT_SPEC = exports.AI2_DEMO_CONTEXT = void 0;
exports.mockBreathState = mockBreathState;
...
exports.mockDetonateBrief = mockDetonateBrief;
exports.mockDetonateDone = mockDetonateDone;
exports._resetMockDetonator = _resetMockDetonator;
...
function mockBreathState(pattern, sessionStartMs, _plannedDurationSec) {
...
exports.AI2_DEMO_CONTEXT = `Positioning\n` +
...
exports.AI2_DEMO_ARTIFACT_SPEC = `Produce ai2-demo-story.html — a self-contained, single-file demo deck (no external\n` +
...
let mockGhostStatus = "armed";
function mockDetonateBrief() {
    if (mockGhostStatus !== "armed")
        return null;
    return {
        ...
        context: exports.AI2_DEMO_CONTEXT,
        artifact_spec: exports.AI2_DEMO_ARTIFACT_SPEC,
        suggested_block: { title: "DaoBrew · AI2 demo story prep", start_offset_min: 60, duration_min: 45 },
    };
}
function mockDetonateDone(causeId) {
    if (causeId === "ghost_ai2_demo_story")
        mockGhostStatus = "done";
    return { status: "done", cause_id: causeId };
}
/** Reset detonator mock state — for tests only. */
function _resetMockDetonator() {
