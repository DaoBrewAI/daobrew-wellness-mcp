...
exports.PERMISSIVE_TABLES = exports.USER_SCOPED_TABLES = exports.RLS_GUC = void 0;
exports.appRoleProvisionSql = appRoleProvisionSql;
/** Session GUC carrying the tenant id; policies read it with `current_setting(..., true)`. */
exports.RLS_GUC = "app.daobrew_user_id";
/** Tables whose rows belong to exactly one user (all have a user_id column). */
exports.USER_SCOPED_TABLES = [
    "graph_nodes",
    "graph_edges",
    "events",
    "meeting_notes",
...
exports.PERMISSIVE_TABLES = [
    "pipeline_metrics",
    "transfer_records",
    "population_priors",
];
const _userScopedAreTables = exports.USER_SCOPED_TABLES;
const _permissiveAreTables = exports.PERMISSIVE_TABLES;
 ...
 */
function appRoleProvisionSql(roleName) {
