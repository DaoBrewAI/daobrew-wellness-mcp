...
exports.POSTGRES_RUNTIME_VERIFY_SQL = exports.POSTGRES_INDEXES = exports.WARM_DB_BYTES_SQL = exports.POSTGRES_TABLES = void 0;
exports.POSTGRES_TABLES = [
    "graph_nodes",
    "graph_edges",
    "events",
    "meeting_notes",
 ...
 */
exports.WARM_DB_BYTES_SQL = `SELECT (${exports.POSTGRES_TABLES.map((name) => `COALESCE(pg_total_relation_size(to_regclass('${name}')), 0)`).join(" + ")}) AS bytes`;
exports.POSTGRES_INDEXES = [
    "ux_nodes_dedup",
    "ux_events_dedup",
 ...
 */
exports.POSTGRES_RUNTIME_VERIFY_SQL = `
