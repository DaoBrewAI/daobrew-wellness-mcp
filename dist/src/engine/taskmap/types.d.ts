 ...
 */
export declare const TASKMAP_CONTRACT_VERSION: "taskmap.v1";
export declare const TASKMAP_ALGORITHM_POLICY_VERSION: "taskmap-policy.2";
export declare const TASKMAP_SOURCE_ENVELOPE_VERSION: "taskmap-source-envelope.v1";
export declare const TASKMAP_DISCOVERY_POINTER_VERSION: "taskmap-discovery-pointer.v1";
export declare const TASKMAP_CONNECTOR_CHECKPOINT_VERSION: "taskmap-connector-checkpoint.v1";
export declare const TASKMAP_CANONICAL_MEETING_VERSION: "taskmap-canonical-meeting.v1";
export declare const TASKMAP_SOURCE_SNAPSHOT_VERSION: "taskmap-source-snapshot.v1";
export declare const TASKMAP_SEMANTIC_PROPOSAL_REFERENCE_VERSION: "taskmap-semantic-proposal-reference.v1";
export declare const TASKMAP_GATE_DECISION_VERSION: "taskmap-gate-decision.v1";
export declare const TASKMAP_REPLAY_MANIFEST_VERSION: "taskmap-replay-manifest.v1";
export declare const TASKMAP_PROJECTION_DIFF_VERSION: "taskmap-projection-diff.v1";
export declare const TASKMAP_PROJECTION_TARGET_VERSION: "taskmap-projection-target.v1";
export declare const TASKMAP_PROJECTION_PARITY_VERSION: "taskmap-projection-parity.v1";
export type TaskMapExperimentArm = "E0" | "E1" | "E2" | "E3" | "E4";
export type TaskMapSourceKind = "linear" | "jira" | "github" | "slack" | "google_chat" | "gmail" | "google_calendar" | "local_calendar" | "google_tasks" | "gemini_meet" | "granola" | "codex_session" | "claude_session" | "cursor_session" | "oura" | "strategy" | "manual" | "unknown";
export type TaskMapRecordKind = "authoritative_task" | "work_context" | "body_context" | "receipt";
export type TaskMapAuthority = "source_system" | "user" | "none";
export type TaskMapSyncMode = "native_agent" | "writeback" | "return_only" | "reference_only" | "personal_fork";
export type TaskMapCapability = "read_task" | "read_context" | "create_task" | "update_status" | "comment_or_reply" | "create_source_draft" | "publish_or_send" | "delegate_native_agent" | "attach_or_link_artifact" | "deep_link" | "webhook_or_incremental_sync" | "optimistic_version_check";
...
export type TaskMapSourceObjectType = "authoritative_task" | "meeting_note" | "calendar_event" | "agent_session" | "body_context" | "strategy_context";
export type TaskMapEvidenceAuthority = "authoritative_task" | "explicit_commitment" | "provider_generated_summary" | "context_only" | "body_context_only";
export type TaskMapEvidenceQuality = "source_native" | "structured_generated" | "provider_summary" | "degraded_summary" | "bounded_context" | "coverage_only";
...
export type TaskMapRankEligibility = "accepted_work" | "candidate_only" | "context_only" | "body_bonus_only";
...
export type TaskMapDeterministicGate = "identity" | "privacy" | "dedupe" | "authority" | "lifecycle" | "completion" | "supersede" | "dependency" | "rank";
...
export type TaskMapActivity = "task_created" | "task_updated" | "task_completed" | "task_reopened" | "commitment_stated" | "decision_deferred" | "decision_made" | "artifact_delivered" | "receipt_observed" | "context_observed" | "body_window_observed";
export type TaskMapSourceStatus = "open" | "in_progress" | "blocked" | "awaiting_review" | "completed" | "cancelled" | "unknown";
export interface TaskMapEvent {
    ...
    bodyAxis?: "hrv" | "resting_heart_rate" | "sleep" | "readiness" | "activity" | "composite_recovery" | "unknown";
...
export type BrainTaskOpenState = "open" | "possibly_open" | "blocked" | "awaiting_review" | "completed" | "superseded" | "unknown";
...
export type BrainRelation = "advances" | "depends_on" | "blocks" | "informed_by" | "related_to" | "supersedes";
...
export type CausalGrade = "C0_NO_DATA" | "C1_CORRELATION" | "C2_ATTRIBUTION_CANDIDATE" | "C3_CAUSAL_HYPOTHESIS" | "C4_VALIDATED_PATTERN";
...
export type TaskMapReviewState = "accepted" | "proposed" | "dismissed" | "source_complete" | "superseded";
...
export type TaskMapProjectionRecordRole = "shared_accepted_work" | "strategy_durable_context" | "taskmap_candidate_review" | "taskmap_operational_detail";
...
export interface TaskMapProjectionParityFindingV1 {
    canonicalRecordId: string;
    code: "strategy_durable_context_only" | "taskmap_candidate_review_only" | "taskmap_operational_detail_only" | "shared_work_missing_strategy" | "shared_work_missing_task_map" | "source_identity_mismatch" | "role_mismatch" | "lifecycle_mismatch" | "accepted_delta_mismatch";
}
...
export interface TaskMapReplayPolicyBindingV1 {
    name: "source" | "normalization" | "identity" | "privacy" | "dedupe" | "authority" | "lifecycle" | "completion" | "supersede" | "dependency" | "rank" | "algorithm";
    version: string;
    digest: string;
}
...
export declare const TASKMAP_BODY_CONTEXT_CONTRACT_VERSION: "taskmap-body-context.v1";
export type TaskMapBodyCategory = "below_baseline" | "within_baseline" | "above_baseline" | "unknown";
export type TaskMapBodyAxis = "hrv" | "resting_heart_rate" | "sleep" | "readiness" | "activity" | "composite_recovery" | "unknown";
/**
 ...
 */
export declare const TASKMAP_TRUTH_SET_DRAFT_VERSION: "taskmap-truth-set-draft.v1";
export declare const TASKMAP_TRUTH_SET_VERSION: "taskmap-truth-set.v1";
export declare const TASKMAP_TRUTH_LABEL_POLICY_VERSION: "taskmap-truth-label-policy.4";
export declare const TASKMAP_TRUTH_TIME_SPLIT_POLICY_VERSION: "taskmap-truth-time-splits.1";
export declare const TASKMAP_TRUTH_REVIEW_BATCH_POLICY_VERSION: "taskmap-truth-review-batch-policy.1";
export declare const TASKMAP_OWNER_TRUTH_SET_VERSION: "taskmap-owner-truth-set.v2";
...
export type TaskMapTruthWorkClass = "explicit_work" | "inferred_candidate" | "context_only" | "non_work";
export type TaskMapTruthEvidenceRole = "primary_authority" | "corroborating_variant" | "identity_anchor" | "discovery_pointer" | "delegated_execution";
export type TaskMapTruthAdjudication = "accepted_work" | "candidate_review" | "context_only" | "merge_into_existing" | "exclude_duplicate" | "reject_pollution";
export type TaskMapTruthLifecycle = "open" | "blocked" | "awaiting_review" | "completed" | "superseded" | "unknown";
export type TaskMapTruthExpectedDelta = "none" | "new_root" | "new_accepted_work" | "update_existing_work" | "new_candidate" | "merge_existing_work";
export type TaskMapTruthLabelAuthority = "source_authority" | "reviewed_truth" | "deterministic_policy";
export type TaskMapTruthSessionRole = "root" | "subagent" | "wrapper";
export type TaskMapTruthReasonCode = "source_native_open_work" | "source_native_blocked_work" | "strategy_durable_context" | "provider_corroborates_existing" | "gmail_discovery_semantically_neutral" | "no_bounded_calendar_anchor" | "calendar_identity_anchor" | "structured_meeting_primary" | "provider_variant_deduped" | "meeting_recurrence_counted_once" | "existing_work_match" | "owner_missing_candidate_review" | "strategy_reviewed_existing_work_merge" | "strategy_blocker_candidate_review" | "asr_pollution" | "numeric_asr_pollution" | "session_continues_existing_root" | "delegated_subagent_not_independent_work" | "wrapper_not_work" | "source_completion_terminal" | "superseded_terminal" | "body_context_post_membership_only" | "unlinked_body_coverage" | "existing_work_updated" | "strategy_source_authority" | "no_automatic_task_acceptance";
export interface TaskMapTruthExpectedProjectionV1 {
    strategy: "shared_accepted_work" | "strategy_durable_context" | "excluded";
    taskMap: "shared_accepted_work" | "taskmap_candidate_review" | "taskmap_operational_detail" | "excluded";
}
