...
exports.STRESS_PATTERN_COPY = void 0;
exports.shortStatusLine = shortStatusLine;
exports.STRESS_PATTERN_COPY = {
    tension: {
        label: "TENSION",
        emoji: "🌲",
    ...
    stagnation: {
        ...
        en: "Three back-to-back meetings just ended. Back at your IDE, cursor's been blinking on line 47 for 20 minutes. Slack has 12 unread. You haven't opened it.",
        zh: "三个会刚连着开完，回 IDE。光标在第 47 行闪了 20 分钟。Slack 12 条未读，你没点开。",
        color: "#F59E0B",
        colorDark: "#B45309",
    },
    constriction: {
...
function shortStatusLine(pattern, hr, elapsedSec, totalSec) {
    const copy = exports.STRESS_PATTERN_COPY[pattern];
