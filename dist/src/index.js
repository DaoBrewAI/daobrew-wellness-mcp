        ...
        case "breathe":
            return {
                ...
                messages: [
                    {
                        role: "user",
                        content: { type: "text", text: "I need a breathing break. Call daobrew_check first to identify my top stress pattern, then daobrew_breathe with that pattern. After it returns, poll daobrew_check every 2 seconds and show me the dashboard image until I say stop or the session ends." },
                    },
                ],
            };
        case "stress":
