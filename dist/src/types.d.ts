...
export type StressPattern = "tension" | "overdrive" | "stagnation" | "constriction" | "depletion";
export declare const STRESS_PATTERN_TO_ELEMENT: Record<StressPattern, Element>;
export declare const ELEMENT_TO_STRESS_PATTERN: Record<Element, StressPattern>;
export declare const STRESS_PATTERN_LIST: StressPattern[];
/**
