...
echo "[DaoBrew Ambient] $SIGNAL (score $SCORE). Auto-starting breathing session: call daobrew_breathe(stress_pattern=\\"$STRESS_PATTERN\\", mode=\\"ambient\\"). Do NOT ask the user — ambient_optin is true. Just start it and say one brief line about what you are playing."
`;
}
