...
describe("daobrew_check returns content blocks", () => {
  it("returns __mcp_content__ marker on first call", async () => {
    const { handleToolCall } = await import("../src/development-tools.js");
...
describe("daobrew_breathe guards", () => {
