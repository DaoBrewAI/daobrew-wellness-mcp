...
import { handleToolCall, toolDefinitions } from "../src/development-tools.js";
...
describe("e2e mock-mode flow (6-tool surface)", () => {
  ...
  it("lists all 10 tool definitions (wellness 7 + detonator 3)", () => {
    assert.strictEqual(toolDefinitions.length, 10);
